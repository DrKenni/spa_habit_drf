    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tg_chat_id', models.CharField(blank=True, max_length=35, null=True, verbose_name='чат id')),
                ('tg_username', models.CharField(blank=True, max_length=100, null=True, verbose_name='Ник в телеграме')),
